...
export default function HomeCleaningPage() {
  return (
    <ServicePageTemplate
      ...
      description="Our recurring and one-time home cleaning plans are built around your lifestyle. We focus on high-touch details, kitchen and bathroom sanitation, and a polished finish in every room."
