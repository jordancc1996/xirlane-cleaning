  ...
  return (
    <main className="bg-background">
      <section className="relative h-[500px] overflow-hidden">
        <img
          src="https://images.unsplash.com/photo-1521790361543-f645cf042ec4?w=1800&q=80"
        ...
        >
          <div className="grid gap-8 lg:grid-cols-2">
            {services.map((service) => (
              <Link key={service.href} href={service.href} className="group block overflow-hidden border border-border-light bg-white">
                ...
                <div className="p-8">
                  <h3 className="text-h3-mobile md:text-h3">{service.name}</h3>
