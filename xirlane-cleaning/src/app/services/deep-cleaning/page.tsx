...
export const metadata = buildServiceMetadata("/services/deep-cleaning");

export default function DeepCleaningPage() {
  return (
    <>
      <ServicePageJsonLd path="/services/deep-cleaning" breadcrumbName="Deep Cleaning" />
      <ServicePageTemplate
        servicePath="/services/deep-cleaning"
        eyebrow="DEEP CLEANING"
        title="Deep Cleaning"
        heroImage="https://images.unsplash.com/photo-1581578731548-c64695cc6952?w=1600&q=80"
        description="Our deep cleaning service is designed for first-time visits, seasonal refreshes, and spaces that need extra detail across Philadelphia and surrounding counties. We go beyond routine maintenance to restore clarity and comfort."
      ...
      />
      <LocalTrustSignals />
      <ServiceAreaSection highlight="deepCleaning" />
    </>
  );
}
